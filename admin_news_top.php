...
$totalRows_Recordset1 = mysql_num_rows($Recordset1);mysql_select_db($database_owl_bookstore, $owl_bookstore);
$query_Recordset1 = "SELECT * FROM owl_news_top ORDER BY ont_id ASC";
$Recordset1 = mysql_query($query_Recordset1, $owl_bookstore) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
     ...
     <div class="col-md-3">
      <div class="panel panel-default">
       ...
       <div class="list-group">
        ...
        <a href="javascript:;" class="list-group-item active">最新消息</a>
     ...
     <div class="col-md-8">
      ...
      <div class="panel panel-default">
       ...
       <table class="table">
         <?php do { ?>
          <tr>
            <td><?php echo $row_Recordset1['ont_title']; ?></td>
            <td><?php echo $row_Recordset1['ont_date']; ?></td>
            <td>[<a href="admin_news_top_update.php?ont_id=<?php echo $row_Recordset1['ont_id']; ?>">修改</a>]</td>
          </tr>
