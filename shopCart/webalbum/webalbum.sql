...
(1, '2009-10-20 12:11:53', '清水', '清水路邊老攤冰店', '清水路邊老攤冰店，很古早味的冰。'),
(2, '2009-10-20 12:13:08', '樹太老定食', '一家三口聚餐', '樹太老定食，不錯吃。'),
(3, '2009-10-20 12:14:37', '大翔書局', '十月份慶生', '幫朋友小朋友十月份慶生'),
(4, '2009-10-20 12:15:16', '三育書院', '三育書院', '三育書院很漂亮，假日可以進去逛逛。'),
(5, '2009-10-20 12:16:18', '文淵閣工作室', '忙碌的工作室', '大家忙著做卡片，很忙啊！'),
(6, '2009-10-20 12:17:22', '清水牛肉麵', '兒子吃牛肉麵', '清水牛肉麵，很好吃，看兒子的樣子就知道了。'),
(7, '2009-10-20 12:18:31', '埔里往武嶺的路上', '武嶺單車之旅', '武嶺，我來了。'),
(8, '2009-10-20 12:22:39', '高美溼地', '高美溼地', '高美溼地，怎麼拍都好看。'),
(9, '2009-10-20 12:24:31', '各處', '可愛的兒子', '嗯，真是可愛，誰生的嘛～～～');
...
CREATE TABLE IF NOT EXISTS `albumphoto` (
  ...
  `ap_hits` int(11) unsigned DEFAULT '0',
  PRIMARY KEY (`ap_id`)
...
(42, 9, '可愛的兒子', '2008-10-20 12:25:25', 'DSCN3693.JPG', 2),
(43, 9, '可愛的兒子', '2008-10-20 12:25:44', 'IMAGE_00038.jpg', 4),
