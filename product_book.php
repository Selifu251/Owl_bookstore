...
$query_Recordset1 = "SELECT * FROM owl_book where ob_id=".$_GET['id'];
    ...
    <div class="container">
     <div class="row">
      ...
      <div class="col-md-9">
       <!-- 商品圖片 -->
       <div class="col-md-4">
        <img src="<?php echo $row_Recordset1['ob_img']; ?>" class="img-responsive" />
       </div>
       <!-- // 商品圖片 -->
       <!-- 商品資料 -->
       <div class="col-md-8">
        <ul class="list-group">
         <li class="list-group-item">書名：<?php echo $row_Recordset1['ob_name']; ?></li>
         <li class="list-group-item">作者：<?php echo $row_Recordset1['ob_author']; ?></li>
         <li class="list-group-item">出版社：<?php echo $row_Recordset1['ob_publishing']; ?></li>
         <li class="list-group-item">出版日：<?php echo $row_Recordset1['ob_publication_day'] ?></li>
         <li class="list-group-item">ISBN：<?php echo $row_Recordset1['ISBN']; ?></li>
         <li class="list-group-item">價格：<?php echo $row_Recordset1['ob_price']; ?></li>
         <li class="list-group-item">簡介：<?php echo $row_Recordset1['ob_content']; ?></li>
        </ul>
