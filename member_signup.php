...
<?php
 $passErr=0;
 if(@$_POST['ou_password_1']!=@$_POST['ou_password_2']){ /* 密碼錯誤時 */
	 $passErr=1;
 }else{ /* 密碼正確時 */
?>
<?php
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "signup_form")) {
  $insertSQL = sprintf("INSERT INTO owl_user (ou_username, ou_password, ou_email) VALUES (%s, %s, %s)",
                       GetSQLValueString($_POST['ou_username'], "text"),
    ...
    <div class="container">
     ...
     <div class="col-md-8">
      <div class="panel panel-info">
       ...
       <form method="POST" action="<?php echo @$editFormAction; ?>" id="signup_form" name="signup_form">
        <tr>
         <td>
          <div class="col-md-2 col-xs-3">帳號：</div>
          <div class="col-md-10 col-xs-9"><input class="form-control" type="text" id="ou_username" name="ou_username"></div>
         </td>
        </tr>
        <tr>
         <td>
          <div class="col-md-2 col-xs-3">E-mail：</div>
          <div class="col-md-10 col-xs-9"><input class="form-control" type="email" id="ou_email" name="ou_email"></div>
         </td>
        </tr>
        <tr>
         <td>
          <div class="col-md-2 col-xs-3">密碼：</div>
          <div class="col-md-10 col-xs-9"><input class="form-control" type="password" id="ou_password_1" name="ou_password_1"></div>
         </td>
        </tr>
        <tr>
         <td>
          <div class="col-md-2 col-xs-3">確認密碼：</div>
          <div class="col-md-10 col-xs-9"><input class="form-control" type="password" id="ou_password_2" name="ou_password_2"></div>
         </td>
        </tr>
        <?php if($passErr==1){ ?>
        <tr>
         <td class="bg-danger text-center">
          <div><h4 style="color:#F00;">***[密碼錯誤]***</h4></div>
         </td>
        </tr>
        <?php } ?>
        <tr>
         <td>
          <input class="btn btn-success form-control" type="submit" name="Submit" value="會員註冊">
         </td>
        </tr>
