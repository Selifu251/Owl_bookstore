...
<div class="row">
      ...
      <div class="col-md-9">
       <!-- 商品第1列 -->
       <?php $row_cot=0; while($row_cot<3){ ?>
       <div class="row">
        <!-- 1-1 -->
        <?php $col_cot=0; do { ?>
        <?php if($row_Recordset1['ob_id']==""){break;} ?>
        <div class="col-md-4">
          <div class="thumbnail"> <a href="project_book.php?id=<?php echo $row_Recordset1['ob_id'] ?>"><img src="images/m2.jpg" /></a>
            <div class="caption">
          ...
          <?php $col_cot++; if($col_cot>=3){ break; };?>
